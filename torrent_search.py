...
def search_torrents(query, category="search"):
    ...
    try:
        ...
        print(f"{Colors.RED}Error: Invalid JSON response{Colors.NC}")
        return []
    ...
    try:
        ...
        try:
            ...
            if result.get("result") == "success":
                ...
                print(f"{Colors.RED}Error: Failed to add torrent - {result.get(result, UnknownError)}{Colors.NC}")
                return False
...
def show_transmission_status():
    ...
    try:
        ...
        print(f"{Colors.RED}Error: Invalid response from Transmission{Colors.NC}")
